...
/**
 * Title: Site Footer
 * Slug: anandiitaa-block/site-footer
 * Inserter: no
 *
 * EXACT-REPLICA of classic my-custom-theme/footer.php (the markup above
 * wp_footer): brand/socials/legal column, footer nav, corporate-info column,
 * copyright line. Referenced by parts/footer.html so PHP (home_url) resolves
 * at pattern-registration time.
 */
?>
